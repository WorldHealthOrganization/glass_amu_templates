...
namespace AMU_Template.Parsers
{
    public static class CommonParser
    {
        ...
        public static bool? ParseBoolean(dynamic cellValue, string variable, ErrorStatus es, ref string variableErrors, bool mandatory, bool? defValue=null)
        {
